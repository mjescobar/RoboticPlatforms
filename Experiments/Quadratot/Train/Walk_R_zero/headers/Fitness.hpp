...
#define ANGULAR_VELOCITY_FITNESS(X) (double)(exp(-pow((X - ANGULAR_VELOCITY_OBJETIVE)/GAUSSIAN_STDD, 2.0)/2.0)*AMPLITUDE/sqrt(2*M_PI*GAUSSIAN_STDD*GAUSSIAN_STDD) + 0.000001)
